...
The [Rheological and flow analysis model](docs/Rheological and flow analysis model.ipynb) is where I modelled some different Newtionian and Non-newtionian fluid proerties using PyBAMM and [Slot-die coating model.ipynb](docs/Slot-die coating model.ipynb) is my current working file which models the velocity profile of the fluid under the nozel of the slot-die head. 
